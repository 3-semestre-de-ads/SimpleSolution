...
public class Frequencia extends JPanel {
    ...
    public Frequencia() {
        ...
        jcomp8.setBounds (25, 180, 260, 70);
        ...
        jcomp13.setBounds (315, 225, 100, 25);
    }


    public static void main (String[] args) {
        JFrame frame = new JFrame ("Frequencia");
        frame.setDefaultCloseOperation (JFrame.EXIT_ON_CLOSE);
        frame.getContentPane().add (new Frequencia());
        frame.pack();
